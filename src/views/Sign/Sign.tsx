...
import { toZero } from '../../utils/common' //补0函数
...
// 此处的ts很重要,目的是表头和表数据互相限制
// typeof DetailKey              //{normal:'正常出勤',xxx}变成了对象字面量类型
// keyof typeof DetailKey        //'normal' | 'absent'  变成了联合类型
// Record<keyof typeof DetailKey, number>      //最终变成了{normal:number,absent:number,xxx}
